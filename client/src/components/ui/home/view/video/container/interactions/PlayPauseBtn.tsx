...
export default function PlayPauseBtn({ videoRef }: Props) {
  ...
  return (
      ...
      <label className="pause-play-container">
        <input
          onChange={handleTogglePlayPause}
          type="checkbox"
          checked={isPlaying}
        />
        <svg
          ...
          className={isPlaying ? "play hide" : "play"}
        >
        ...
        <svg
          ...
          height="1em"
          xmlns="http://www.w3.org/2000/svg"
          className={isPlaying ? "pause" : "pause hide"}
        >
